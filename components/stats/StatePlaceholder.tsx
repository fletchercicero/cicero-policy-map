...
export default function StatePlaceholder({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-4 sm:p-6 md:p-8 text-center">
      <MapPin className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-[#b09c71] mb-4 sm:mb-6 opacity-40" />
      
      <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#172c49] mb-2 sm:mb-3">
        Select a State
      </h2>
